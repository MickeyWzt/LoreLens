...
export function readServerConfig(env: NodeJS.ProcessEnv = process.env): ServerConfig {
  ...
  return {
    ...
    tts: {
      ...
      qwen: {
        apiKey: env.QWEN_TTS_API_KEY || env.QWEN_API_KEY || env.DASHSCOPE_API_KEY,
        model: env.QWEN_TTS_MODEL || 'qwen3-tts-flash',
        baseUrl: env.QWEN_TTS_BASE_URL || 'https://dashscope.aliyuncs.com/api/v1',
        timeoutMs: numberInRange(env.QWEN_TTS_TIMEOUT_MS, 30_000, 1_000, 120_000),
    ...
    capabilities: {
      ...
      tts: Boolean(env.MIMO_API_KEY || env.QWEN_TTS_API_KEY || env.QWEN_API_KEY || env.DASHSCOPE_API_KEY),
