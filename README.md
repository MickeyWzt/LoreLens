...
- 自然朗读：中文和英文使用小米 `mimo-v2.5-tts`；日、韩、西、法、德、意、葡、俄语使用低延迟的 `qwen3-tts-flash`；阿拉伯语、离线或云端故障时使用设备语音。
...
- 十一种语言：简体中文、英语、日语、韩语、西班牙语、法语、德语、意大利语、葡萄牙语、俄语和阿拉伯语，包含 RTL、键盘操作、减少动效和安全区适配。
...
| `QWEN_TTS_API_KEY` | 复用 `QWEN_API_KEY` | 可选独立千问 TTS 密钥 |
| `QWEN_TTS_MODEL` | `qwen3-tts-flash` | 日、韩、西、法、德、意、葡、俄语云端朗读模型 |
| `QWEN_TTS_BASE_URL` | `https://dashscope.aliyuncs.com/api/v1` | 千问原生 TTS API Base URL |
| `QWEN_TTS_VOICE` | `Cherry` | 千问多语言系统音色 |
